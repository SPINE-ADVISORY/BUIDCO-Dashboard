...
import { LOGO_B64 } from "../../config/logoB64";
  ...
  >
    <div
      style={{
        ...
        height: "100%",
        background: color || pctColor(value),
        borderRadius: 3,
        transition: "width .5s",
      }}
    />
...
export const KpiCard = ({
  ...
  <div
    ...
    style={{
      ...
      transition: "all .18s",
      position: "relative",
      boxShadow: "0 1px 4px rgba(13,33,55,.06)",
    }}
    onMouseEnter={(e) => {
      if (onClick) {
        e.currentTarget.style.boxShadow = "0 6px 20px rgba(13,33,55,.12)";
        e.currentTarget.style.transform = "translateY(-2px)";
      }
    }}
    onMouseLeave={(e) => {
      e.currentTarget.style.boxShadow = "0 1px 4px rgba(13,33,55,.06)";
  ...
  >
    ...
    >
      ...
      <div style={{ fontSize: 26, opacity: 0.15, marginTop: 2 }}>{icon}</div>
    </div>
    {onClick && (
      <div
        style={{
  ...
  >
    <div
      style={{
        ...
        maxHeight: "90vh",
        overflow: "auto",
        boxShadow: "0 24px 64px rgba(13,33,55,.2)",
      }}
